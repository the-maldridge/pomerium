...
// A NACLBoxPublicKey is the public key used for NACL's Box Seal and Open functions.
...
func (x *NACLBoxPublicKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NACLBoxPublicKey) ProtoMessage() {}

func (x *NACLBoxPublicKey) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NACLBoxPublicKey.ProtoReflect.Descriptor instead.
func (*NACLBoxPublicKey) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{5}
}

func (x *NACLBoxPublicKey) GetKey() []byte {
	if x != nil {
		return x.Key
	}
	return nil
...
type Settings struct {
	...
	AuditKey                                          *NACLBoxPublicKey     `protobuf:"bytes,71,opt,name=audit_key,json=auditKey,proto3,oneof" json:"audit_key,omitempty"`
}
...
func (x *Settings) GetAuditKey() *NACLBoxPublicKey {
	if x != nil {
		return x.AuditKey
	}
	return nil
...
var file_config_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x24, 0x0a,
	0x10, 0x4e, 0x41, 0x43, 0x4c, 0x42, 0x6f, 0x78, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65,
	0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03,
	0x6b, 0x65, 0x79, 0x22, 0xdd, 0x2a, 0x0a, 0x08, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73,
	0x12, 0x2c, 0x0a, 0x0f, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x5f, 0x69, 0x64, 0x18, 0x46, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0e, 0x69, 0x6e, 0x73,
	...
	0x01, 0x01, 0x12, 0x40, 0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x44, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x70, 0x6f, 0x6d, 0x65, 0x72, 0x69, 0x75, 0x6d, 0x2e, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x48,
	...
	0x6d, 0x5f, 0x74, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x68, 0x6f, 0x70, 0x73, 0x18, 0x45,
	0x20, 0x01, 0x28, 0x0d, 0x48, 0x38, 0x52, 0x11, 0x78, 0x66, 0x66, 0x4e, 0x75, 0x6d, 0x54, 0x72,
	0x75, 0x73, 0x74, 0x65, 0x64, 0x48, 0x6f, 0x70, 0x73, 0x88, 0x01, 0x01, 0x12, 0x43, 0x0a, 0x09,
	0x61, 0x75, 0x64, 0x69, 0x74, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x47, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x21, 0x2e, 0x70, 0x6f, 0x6d, 0x65, 0x72, 0x69, 0x75, 0x6d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x2e, 0x4e, 0x41, 0x43, 0x4c, 0x42, 0x6f, 0x78, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b,
	0x65, 0x79, 0x48, 0x39, 0x52, 0x08, 0x61, 0x75, 0x64, 0x69, 0x74, 0x4b, 0x65, 0x79, 0x88, 0x01,
	...
	0x6b, 0x65, 0x79, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_config_proto_goTypes = []interface{}{
	...
	(*NACLBoxPublicKey)(nil),     // 5: pomerium.config.NACLBoxPublicKey
	...
	nil,                          // 12: pomerium.config.Settings.HeadersEntry
...
var file_config_proto_depIdxs = []int32{
	...
	8,  // 5: pomerium.config.Route.set_request_headers:type_name -> pomerium.config.Route.SetRequestHeadersEntry
	1,  // 6: pomerium.config.Route.rewrite_response_headers:type_name -> pomerium.config.RouteRewriteHeader
	15, // 7: pomerium.config.Route.envoy_opts:type_name -> envoy.config.cluster.v3.Cluster
	4,  // 8: pomerium.config.Route.policies:type_name -> pomerium.config.Policy
	9,  // 9: pomerium.config.Policy.allowed_idp_claims:type_name -> pomerium.config.Policy.AllowedIdpClaimsEntry
	10, // 10: pomerium.config.Settings.certificates:type_name -> pomerium.config.Settings.Certificate
	14, // 11: pomerium.config.Settings.timeout_read:type_name -> google.protobuf.Duration
	14, // 12: pomerium.config.Settings.timeout_write:type_name -> google.protobuf.Duration
	14, // 13: pomerium.config.Settings.timeout_idle:type_name -> google.protobuf.Duration
	14, // 14: pomerium.config.Settings.cookie_expire:type_name -> google.protobuf.Duration
	14, // 15: pomerium.config.Settings.idp_refresh_directory_timeout:type_name -> google.protobuf.Duration
	14, // 16: pomerium.config.Settings.idp_refresh_directory_interval:type_name -> google.protobuf.Duration
	11, // 17: pomerium.config.Settings.request_params:type_name -> pomerium.config.Settings.RequestParamsEntry
	12, // 18: pomerium.config.Settings.headers:type_name -> pomerium.config.Settings.HeadersEntry
	13, // 19: pomerium.config.Settings.jwt_claims_headers:type_name -> pomerium.config.Settings.JwtClaimsHeadersEntry
	14, // 20: pomerium.config.Settings.refresh_cooldown:type_name -> google.protobuf.Duration
	14, // 21: pomerium.config.Settings.default_upstream_timeout:type_name -> google.protobuf.Duration
	10, // 22: pomerium.config.Settings.metrics_certificate:type_name -> pomerium.config.Settings.Certificate
	14, // 23: pomerium.config.Settings.grpc_server_max_connection_age:type_name -> google.protobuf.Duration
	14, // 24: pomerium.config.Settings.grpc_server_max_connection_age_grace:type_name -> google.protobuf.Duration
	5,  // 25: pomerium.config.Settings.audit_key:type_name -> pomerium.config.NACLBoxPublicKey
